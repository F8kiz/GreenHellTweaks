...
namespace GHTweaks.Patches
{
    ...
    internal class BirdHouseConstructor
    {
        ...
        {
#if DEBUG
            Mod.Instance.WriteLog($"BirdHouse.Constructor.Postfix enter BridHouse constructor");
#endif 
            ...
            {
#if DEBUG
                Mod.Instance.WriteLog($"BirdHouse.Constructor.Postfix set m_MaxBirdsCount: {config.MaxBirdsCount}");
#endif 
            ...
            {
#if DEBUG
                Mod.Instance.WriteLog($"BirdHouse.Constructor.Postfix set m_SpawnBirdsDelay: {config.SpawnBirdsDelay}");
#endif 
            ...
            {
#if DEBUG
                Mod.Instance.WriteLog($"BirdHouse.Constructor.Postfix set m_DomesticationTime: {config.DomesticationTime}");
#endif 
            ...
            {
#if DEBUG
                Mod.Instance.WriteLog($"BirdHouse.Constructor.Postfix set m_BirdKillPenaltyTime: {config.BirdKillPenaltyTime}");
#endif 
